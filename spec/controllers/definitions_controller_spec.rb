...
RSpec.describe DefinitionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested definition as @definition" do
      definition = Definition.create! valid_attributes
      get :show, params: {id: definition.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested definition as @definition" do
      definition = Definition.create! valid_attributes
      get :edit, params: {id: definition.to_param}, session: valid_session
      expect(assigns(:definition)).to eq(definition)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Definition" do
        expect {
          post :create, params: {definition: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved definition as @definition" do
        post :create, params: {definition: invalid_attributes}, session: valid_session
        expect(assigns(:definition)).to be_a_new(Definition)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested definition" do
        definition = Definition.create! valid_attributes
        put :update, params: {id: definition.to_param, definition: new_attributes}, session: valid_session
        definition.reload
      ...
      it "assigns the requested definition as @definition" do
        definition = Definition.create! valid_attributes
        put :update, params: {id: definition.to_param, definition: valid_attributes}, session: valid_session
        expect(assigns(:definition)).to eq(definition)
      end
    ...
    context "with invalid params" do
      it "assigns the definition as @definition" do
        definition = Definition.create! valid_attributes
        put :update, params: {id: definition.to_param, definition: invalid_attributes}, session: valid_session
        expect(assigns(:definition)).to eq(definition)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested definition" do
      definition = Definition.create! valid_attributes
      expect {
        delete :destroy, params: {id: definition.to_param}, session: valid_session
      }.to change(Definition, :count).by(-1)
    end
